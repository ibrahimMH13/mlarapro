...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Ibrhaim13\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Ibrhaim13\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Ibrhaim13\Admin\AdminServiceProvider']);
...
//        \Ibrhaim13\Admin\Admin::$css = [];
//        \Ibrhaim13\Admin\Admin::$js = [];
//        \Ibrhaim13\Admin\Admin::$script = [];
    }
